<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tejaform.aspx.cs" Inherits="WebApplication5.tejaform" %>
...
<br />
<asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Age between 18 to 60" MaximumValue="60" MinimumValue="18" ValidationGroup="vg" Type="Integer"></asp:RangeValidator>
<br />
